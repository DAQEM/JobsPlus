package me.daqem.jobsplus.common.inventory.construction.slot;
...
public class ConstructionResultSlot extends Slot {

    private final ConstructionCraftingContainer craftSlots;
    private final Player player;
    private int removeCount;

    public ConstructionResultSlot(Player p_40166_, ConstructionCraftingContainer p_40167_, Container p_40168_, int p_40169_, int p_40170_, int p_40171_) {
    ...
    public void onTake(Player p_150638_, ItemStack p_150639_) {
        ...
        NonNullList<ItemStack> nonnulllist = p_150638_.level.getRecipeManager().getRemainingItemsFor(ModRecipes.CONSTRUCTION_TYPE.get(), this.craftSlots, p_150638_.level);
