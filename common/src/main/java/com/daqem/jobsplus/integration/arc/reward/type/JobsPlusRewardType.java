...
public interface JobsPlusRewardType<T extends IReward> extends IRewardType<T> {
    ...
    IRewardType<JobExpReward> JOB_EXP = IRewardType.register(JobsPlus.getId("job_exp"), new JobExpReward.Serializer());
    IRewardType<JobExpMultiplierReward> JOB_EXP_MULTIPLIER = IRewardType.register(JobsPlus.getId("job_exp_multiplier"), new JobExpMultiplierReward.Serializer());
    IRewardType<JobCoinReward> JOB_COIN = IRewardType.register(JobsPlus.getId("job_coin"), new JobCoinReward.Serializer());
