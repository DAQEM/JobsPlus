...
public enum ItemTiers implements Tier {
    ...
    LEVEL_1(3, 3543, 8.0F, 0.5F, 10, () -> Ingredient.of(Items.IRON_BLOCK)),
    LEVEL_2(3, 5678, 9.0F, 1.0F, 12, () -> Ingredient.of(Items.GOLD_BLOCK)),
    LEVEL_3(4, 12835, 10.0F, 1.5F, 15, () -> Ingredient.of(Items.DIAMOND_BLOCK)),
