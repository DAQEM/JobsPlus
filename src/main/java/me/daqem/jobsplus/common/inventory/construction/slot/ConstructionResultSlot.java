...
public class ConstructionResultSlot extends Slot {
    ...
    public void onTake(Player p_150638_, ItemStack p_150639_) {
        ...
        NonNullList<ItemStack> nonnulllist = p_150638_.level.getRecipeManager().getRemainingItemsFor(ConstructionRecipeType.INSTANCE, this.craftSlots, p_150638_.level);
